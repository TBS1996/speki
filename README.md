...
[Click to download binary](https://github.com/TBS1996/speki/releases/download/v0.4.2/speki-windows.tar.gz)
...
[Click to download binary](https://github.com/TBS1996/speki/releases/download/v0.4.2/speki-linux.tar.gz)
